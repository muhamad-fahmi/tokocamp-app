...
@section('contents')
    ...
    <section class="main py-5 product">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/cart" method="post">
                        @csrf
                        <input type="hidden" name="id" value="{{ $campinggear->id }}">
        ...
        <div class="container mt-5"><br>
            ...
            <div class="row">
                <div class="px-0 col-12 col-sm-12 col-lg-3">
                    <img src="{{ asset('images/campinggear/'.$campinggear->image) }}" class="w-100" alt="{{ $campinggear->name }}">
                </div>
                <div class="col-12 col-sm-12 col-lg-6 px-4 mt-3">
                    <h4 class="title-prod mb-2">
                        {{ ucwords($campinggear->name) }}
                    </h4>
                    ...
                    <h3 class="price mb-4" data-price="2555">
                        <strong id="price">
                            {{ rupiah($campinggear->price) }}
                        </strong>
                    </h3>

                    <div class="description pt-3 border-1 border-top">
                        <p>{{ ucfirst($campinggear->description) }}</p>
                    </div>
                </div>
                   ...
                   @foreach ($campinggears as $campinggear)
                        <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                            <div class="card border border-0 shadow">
                                <img src="{{ asset('images/campinggear/'.$campinggear->image) }}" class="card-img-top" alt="{{ $campinggear->name }}">
                                <div class="card-body">
                                    <h5 class="card-title">{{ ucwords($campinggear->name) }}</h5>
                                    <p class="card-text price"><strong>{{ rupiah($campinggear->price) }}</strong></p>
                                    <p class="card-text location"><i class="fa-solid fa-location-dot me-1 text-success"></i> {{ ucwords($campinggear->subcategory->area . " (" .str_replace('Kabupaten', 'Kab', $campinggear->subcategory->city).")") }}</p>
